...
public interface TLVType {
    ...
    int TLV_TYPE_EXTENSION_RAILGUN             = 0;
    int TLV_TYPE_RAILGUN_SIZE_OUT              = TLVPacket.TLV_META_TYPE_UINT   | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 1);
    int TLV_TYPE_RAILGUN_STACKBLOB             = TLVPacket.TLV_META_TYPE_RAW    | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 2);
    int TLV_TYPE_RAILGUN_BUFFERBLOB_IN         = TLVPacket.TLV_META_TYPE_RAW    | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 3);
    int TLV_TYPE_RAILGUN_BUFFERBLOB_INOUT      = TLVPacket.TLV_META_TYPE_RAW    | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 4);

    int TLV_TYPE_RAILGUN_BACK_BUFFERBLOB_OUT   = TLVPacket.TLV_META_TYPE_RAW    | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 5);
    int TLV_TYPE_RAILGUN_BACK_BUFFERBLOB_INOUT = TLVPacket.TLV_META_TYPE_RAW   | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 6);
    int TLV_TYPE_RAILGUN_BACK_RET              = TLVPacket.TLV_META_TYPE_QWORD  | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 7);
    int TLV_TYPE_RAILGUN_BACK_ERR              = TLVPacket.TLV_META_TYPE_UINT   | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 8);

    int TLV_TYPE_RAILGUN_LIBNAME               = TLVPacket.TLV_META_TYPE_STRING | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 9);
    int TLV_TYPE_RAILGUN_FUNCNAME              = TLVPacket.TLV_META_TYPE_STRING | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 10);
    int TLV_TYPE_RAILGUN_MULTI_GROUP           = TLVPacket.TLV_META_TYPE_GROUP  | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 11);

    int TLV_TYPE_RAILGUN_MEM_ADDRESS           = TLVPacket.TLV_META_TYPE_QWORD  | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 12);
    int TLV_TYPE_RAILGUN_MEM_DATA              = TLVPacket.TLV_META_TYPE_RAW    | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 13);
    int TLV_TYPE_RAILGUN_MEM_LENGTH            = TLVPacket.TLV_META_TYPE_UINT   | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 14);

    int TLV_TYPE_RAILGUN_CALLCONV              = TLVPacket.TLV_META_TYPE_STRING  | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 15);
    int TLV_TYPE_RAILGUN_BACK_MSG              = TLVPacket.TLV_META_TYPE_STRING  | (TLV_TYPE_EXTENSION_RAILGUN + TLV_EXTENSIONS + 16);

...
// Named pipes
#define TLV_TYPE_NAMED_PIPE_SERVER                    MAKE_CUSTOM_TLV( TLV_META_TYPE_STRING,  TLV_TYPE_EXTENSION_STDAPI, 1600 )
#define TLV_TYPE_NAMED_PIPE_NAME                      MAKE_CUSTOM_TLV( TLV_META_TYPE_STRING,  TLV_TYPE_EXTENSION_STDAPI, 1601 )
#define TLV_TYPE_NAMED_PIPE_OPEN_MODE                 MAKE_CUSTOM_TLV( TLV_META_TYPE_UINT,    TLV_TYPE_EXTENSION_STDAPI, 1602 )
#define TLV_TYPE_NAMED_PIPE_PIPE_MODE                 MAKE_CUSTOM_TLV( TLV_META_TYPE_UINT,    TLV_TYPE_EXTENSION_STDAPI, 1603 )
#define TLV_TYPE_NAMED_PIPE_COUNT                     MAKE_CUSTOM_TLV( TLV_META_TYPE_UINT,    TLV_TYPE_EXTENSION_STDAPI, 1604 )
#define TLV_TYPE_NAMED_PIPE_REPEAT                    MAKE_CUSTOM_TLV( TLV_META_TYPE_BOOL,    TLV_TYPE_EXTENSION_STDAPI, 1605 )

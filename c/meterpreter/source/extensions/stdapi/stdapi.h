...
#define TLV_TYPE_PRIVILEGE                            MAKE_CUSTOM_TLV( TLV_META_TYPE_GROUP,   TLV_TYPE_EXTENSION_STDAPI, 632)
#define TLV_TYPE_PRIVILEGE_NAME                       MAKE_CUSTOM_TLV( TLV_META_TYPE_STRING,  TLV_TYPE_EXTENSION_STDAPI, 633)
#define TLV_TYPE_PRIVILEGE_ENABLED                    MAKE_CUSTOM_TLV( TLV_META_TYPE_BOOL,    TLV_TYPE_EXTENSION_STDAPI, 634)
// Fs
